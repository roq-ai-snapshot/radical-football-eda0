...
import { PlayerProfileInterface, PlayerProfileGetQueryInterface } from 'interfaces/player-profile';
import { GetQueryInterface } from '../../interfaces';

export const getPlayerProfiles = async (query?: PlayerProfileGetQueryInterface) => {
